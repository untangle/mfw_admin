Ext.define('Mfw.setup.step.Welcome', {
    ...
    items: [{
        ...
        html: '<h1>Thanks for choosing Untangle!</h1>' +
            '<p style="font-size: 16px;">A wizard will guide you through the initial setup and configuration of the Server.</p> <br/><hr/>'
    }, {
        xtype: 'component',
        html: '<p style="font-size: 16px;">Before continuing please choose the setup mode for your covenience</p>'
    }, {
        xtype: 'container',
        layout: 'vbox',
        defaults: {
