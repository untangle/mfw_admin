Ext.define('Mfw.store.RuleConditions', {
    ...
    data: [{
        ...
        { type:'DESTINATION_ADDRESS', name: 'Destination Address'.t() },
        { type:'SOURCE_PORT', name: 'Source Port'.t() },
        { type:'DESTINATION_PORT', name: 'Destination Port'.t() },
        { type:'SOURCE_INTERFACE_ZONE', name: 'Source Interface Zone'.t() },
        { type:'DESTINATION_INTERFACE_ZONE', name: 'Destination Interface Zone'.t() },
        { type:'SOURCE_INTERFACE_NAME', name: 'Source Interface Name'.t() },
        { type:'DESTINATION_INTERFACE_NAME', name: 'Destination Interface Name'.t() },
