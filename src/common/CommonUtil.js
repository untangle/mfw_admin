Ext.define('Mfw.CommonUtil', {
    ...
    getInterfaceIcon: function(type, height) {
        ...
        switch (type) {
            ...
            case 'LTE': icon = '<svg xmlns="http://www.w3.org/2000/svg" height='+height+' style="vertical-align:middle;display=inline-block;" viewBox="0 0 24 24"><path d="M3,21H6V18H3M8,21H11V14H8M13,21H16V9H13M18,21H21V3H18V21Z" /></svg>'; break;
            case 'OPENVPN':
